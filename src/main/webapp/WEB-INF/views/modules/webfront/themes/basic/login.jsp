			...
			<div class="main clearfix">
				<form method="post">
					<div class="main-left">
						...
						<div class="input-div clearfix">
							<div class="input-text input-text-error">
								<input type="text" value="" class="input" id="username" name="username"> <span>用户名/手机号</span>
							</div>
							<span class="point point-ico2" style="display: inline;">用户名不能为空</span>
						</div>
						<div class="input-div clearfix">
						...
						<div class="input-div clearfix">
							<div class="login_check">
								<span><i class="cur"></i>自动登录(7天)</span> <a href="http://passport.wdzj.com/user/getpwd?refer=aHR0cDovL3d3dy53ZHpqLmNvbS8=">找回密码？</a>
							</div>
						</div>
						<div class="input-div clearfix">
				...
				<div class="main-right">
					...
					<div class="main-gosign">
						<span>没有账号？</span> <a href="http://passport.wdzj.com/user/register?refer=aHR0cDovL3d3dy53ZHpqLmNvbS8=">立即注册 →</a>
					</div>
				</div>
			</div>
			<script type="text/javascript">
				$(".input-text .input").blur(function() {
					wdzj.user.checkblur1(this, 1);
					return false;
				});
				wdzj.user.checkfocus();
				$(".input-div .submit")
						.click(
								function() {
									if (wdzj.user.checkblur1($('#username'))
											&& wdzj.user.checkblur1(
													$('#password'), 1)) {
