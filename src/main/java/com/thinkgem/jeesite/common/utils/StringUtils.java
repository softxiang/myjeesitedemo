...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
	...
	public static String toCamelCase(String s) {
		...
		/***
		 * 修正如c_x_test返回cXTest在jsp中出现Property XXX not found on type XXX 字段存在
		 * 仍然报错的问题 修正驼峰命名 开始
		 */
	...
	/**
	 * <p>
	 * 将编码过的html字符串反编码，如果为null或者为空字符串则返回""
	 * </p>
	 * 如 &amp;lt;test&amp;gt;将转换为&lt;test&gt</br> null或全部为空的字符串将转换为""</br>
	...
	public static String convertRegExp(final CharSequence regStr) {
		String result = regStr.toString();
		// 正则表达式元字符 ([{\^-$|}])?*+.
		Matcher m = Pattern.compile("[\\(\\[\\{\\\\\\^\\-\\$\\|\\}\\]\\)\\?\\*\\+\\.]").matcher(regStr);
		if (m.find()) {
